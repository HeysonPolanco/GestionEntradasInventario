...
namespace GestionEntradasInventario.Migrations
{
    ...
    [Migration("20260118025305_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionEntradasInventario.Models.Productos", b =>
                {
                    b.Property<int>("ProductoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionEntradasInventario.Models.EntradasDetalle", b =>
                {
                    b.HasOne("GestionEntradasInventario.Models.Entradas", null)
                        .WithMany("EntradasDetalle")
                        .HasForeignKey("EntradaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GestionEntradasInventario.Models.Productos", null)
                        .WithMany()
